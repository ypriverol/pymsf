...
This class has been extended from the original library pyprotoeme, class:
https://github.com/white-lab/pyproteome/blob/master/pyproteome/discoverer/__init__.py
